...
$cancionDTO = $parametros['cancionDTO'];
?>
...
<div class="menu seccion-comentarios ">
                ...
                <div id="id_comentario_<?= $comentarioDTO->id ?>" class="contenedor-comentario">
                    ...
                    <div class="comentario" id="<?= "comentario_" . $comentarioDTO->id ?>">
                        ...
                        <div class="botonera-comentarios">
                            <button id='like' class='boton-interaccion' onclick="darLike('<?= $comentarioDTO->id ?>', this, 'cancion')">
    ...
    <div class="comentar-contenedor">
        ...
        <button class="boton-comentar" disabled onclick="comentar(this, 'cancion', '<?= $cancionDTO->id ?>')">Comentar</button>
    </div>
</div>