...
class ComentarioCancionDTO {
    ...
    public function __construct ($conn, $id) {
        ...
        $comentarioDatos = ModeloComentariosCanciones::seleccionar($conn, $id);
        if (mysqli_num_rows($comentarioDatos) > 0) {
            ...
            if (mysqli_num_rows($usuarioDatos) > 0) {
                ...
                $favDatos = ModeloLikesComentarios::seleccionarFavPorIdComentario($GLOBALS['conn'], $registroUsuario['id'], $registroComentario['id_comentario']);
